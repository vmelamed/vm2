...
public partial class UrisTests
{
    public static UriTheoryData AddressData = new() {
        ...
        { TestLine("Incomplete IPv4"), true, "1.2.3:321", new()
                                                        {
                                                            ["address"] = "1.2.3:321",
                                                            ["host"] = "1.2.3",
                                                            ["ipGenName"] = "1.2.3",
        ...
        { TestLine("Complete unbracketed IPvF"), true, "v1a.skiledh.srethg.23546.:443", new()
                                                        {
        ...
        { TestLine("General name in percent URL encoded"), true, "%D0%B4%D0%B8%D1%80.%D0%B1%D0%B3:8080", new()
                                                        {
    ...
    public static UriTheoryData AuthorityData = new() {
        ...
        { TestLine(), true, "john.doe:secret@1.2.3:321", new()
                                                {
        ...
        { TestLine(), true, "john.doe:secret@v1a.skiledh.srethg.23546.:443", new()
                                                {
        ...
        { TestLine(), true, "john.doe:secret@%D0%B4%D0%B8%D1%80.%D0%B1%D0%B3:8080", new()
                                                {

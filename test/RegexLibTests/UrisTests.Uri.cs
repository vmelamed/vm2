...
public partial class UrisTests
{
    public static UriTheoryData UriData = new () {
        ...
        { TestLine(), true,  "http://192.168.0.1%20hello", new() {
            ...
            ["address"] = "192.168.0.1%20hello", // →address← = →192.168.0.1 hello←
        ...
        { TestLine(), true,  "http://0000000000000300.0x00000000000000fF.00000000000000001", new() {
                ...
                ["address"] = "0000000000000300.0x00000000000000fF.00000000000000001",
        ...
        { TestLine(), true,  "http://0000000000000300.0xffffffffFFFFFFFF.3022415481470977", new() {
                ...
                ["address"] = "0000000000000300.0xffffffffFFFFFFFF.3022415481470977",
        ...
        { TestLine(), true,  "http://0000000000000000100000000000000001", new() {
                ...
                ["address"] = "0000000000000000100000000000000001",
        ...
        { TestLine(), true,  "http://0.0.0.000000000000000000z", new() {
                ...
                ["address"] = "0.0.0.000000000000000000z",
        ...
        { TestLine(), true,  "http://0.0.0.100000000000000000z", new() {
                ...
                ["address"] = "0.0.0.100000000000000000z",
        ...
        { TestLine(), true,  "http://www.example.com:-2", new() {
                ["uri"] = "http://www.example.com:-2",
                ["scheme"] = "http",
                ["pathAbs"] = "/www.example.com:-2",
            } },
        ...
        { TestLine(), true,  "http://f:00000000000000/c", new() {
                ["uri"] = "http://f:00000000000000/c",
                ["scheme"] = "http",
                ["pathAbs"] = "/f:00000000000000/c",
            } },
        { TestLine(), true,  "http://f:00000000000000000000080/c", new() {
            ["uri"] = "http://f:00000000000000000000080/c",
            ["scheme"] = "http",
            ["pathAbs"] = "/f:00000000000000000000080/c",
        } },
        { TestLine(), true,  "http://f:b/c", new() {
                ["uri"] = "http://f:b/c",
                ["scheme"] = "http",
                ["pathAbs"] = "/f:b/c",
            } },
        ...
        { TestLine(), true,  "http://f:fifty-two/c", new() {
                ["uri"] = "http://f:fifty-two/c",
                ["scheme"] = "http",
                ["pathAbs"] = "/f:fifty-two/c",
            } },
        { TestLine(), true,  "http://f:999999/c", new() {
                ["uri"] = "http://f:999999/c",
                ["scheme"] = "http",
                ["pathAbs"] = "/f:999999/c",
            } },
        ...
        { TestLine(), true,  "http://user:pass@/", new() {
                ["uri"] = "http://user:pass@/",
                ["scheme"] = "http",
                ["pathAbs"] = "/user:pass@/",
            } },
        ...
        { TestLine(), true,  "http://%77%77%77%2e%65%78%61%6d%70%6c%65%2e%63%6f%6d%3a%38%30", new() {
                ...
                ["address"] = "%77%77%77%2e%65%78%61%6d%70%6c%65%2e%63%6f%6d%3a%38%30", // →address← = →www.example.com:80←
        ...
        { TestLine(), true,  "http://user%40example.com", new() {
                ...
                ["address"] = "user%40example.com", // →address← = →user@example.com←
        ...
        { TestLine(), true,  "http://user%3Ainfo%40example.com", new() {
                ...
                ["address"] = "user%3Ainfo%40example.com", // →address← = →user:info@example.com←

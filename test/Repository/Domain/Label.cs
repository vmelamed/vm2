...
public class Label(int id, string name, string countryCode = "") : IFindable<Label>, IAuditable, IValidatable
{
    ...
    /// <code><![CDATA[var label = await _repository.Find(Label.ById(42), ct);]]></code>
    /// </summary>
    /// <param name="id">The unique identifier for the label.</param>

...
public class XmlTestsFixture : BaseTestsFixture<XmlTestsFixture>
{
    ...
    public XmlTestsFixture() : base()
    {
        ...
        TestFilesPath = Path.Combine(gitWorkSpace, "test/Linq/ExpressionSerialization/TestsShared/TestData/Xml");
        TestLoadPath  = Path.Combine(TestFilesPath, "LoadTestData");
        SchemasPath   = Path.Combine(gitWorkSpace, "src/Linq/ExpressionSerialization/Xml/Schema");

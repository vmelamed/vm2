...
public class JsonTestsFixture : BaseTestsFixture<JsonTestsFixture>
{
    ...
    public JsonTestsFixture() : base()
    {
        ...
        TestFilesPath = Path.Combine(gitWorkSpace, "test/Linq/ExpressionSerialization/TestsShared/TestData/Json");
        TestLoadPath  = Path.Combine(TestFilesPath, "LoadTestData");
        SchemasPath   = Path.Combine(gitWorkSpace, "src/Linq/ExpressionSerialization/Json/Schema");

...
public partial class FromJsonTransformVisitor
{
    ...
    /// </summary>
    static readonly Dictionary<string, Func<FromJsonTransformVisitor, JElement, Expression>> _transforms_ = new()
    {
    ...
    static readonly FrozenDictionary<string, Func<FromJsonTransformVisitor, JElement, Expression>> _transforms = _transforms_.ToFrozenDictionary();
    #endregion
}

...
partial class FromXmlDataTransform
{
    ...
    static readonly Dictionary<Type, Func<Type, Type, int, IEnumerable, object?>> _sequenceBuilders_ = new ()
    {
        ...
        [typeof(ArraySegment<>)]        = (gt, et, len, seq) => BuildWithConstructor1ArrayParameter(gt, et, TransformToArray(et, len, seq)),
        [typeof(Memory<>)]              = (gt, et, len, seq) => BuildWithConstructor1ArrayParameter(gt, et, TransformToArray(et, len, seq)),
        [typeof(ReadOnlyMemory<>)]      = (gt, et, len, seq) => BuildWithConstructor1ArrayParameter(gt, et, TransformToArray(et, len, seq)),
        [typeof(ConcurrentQueue<>)]     = (gt, et, len, seq) => BuildWithConstructor1EnumerableParameter(gt, et, seq),
        [typeof(ConcurrentStack<>)]     = (gt, et, len, seq) => BuildWithConstructor1EnumerableParameter(gt, et, seq.Cast<object?>().Reverse()),
        [typeof(Stack<>)]               = (gt, et, len, seq) => BuildWithConstructor1EnumerableParameter(gt, et, seq.Cast<object?>().Reverse()),
        [typeof(Collection<>)]          = (gt, et, len, seq) => BuildWithConstructor1ListParameter(gt, et, seq.Cast<object?>().ToList()),
        [typeof(ReadOnlyCollection<>)]  = (gt, et, len, seq) => BuildWithConstructor1ListParameter(gt, et, seq.Cast<object?>().ToList()),
        [typeof(LinkedList<>)]          = (gt, et, len, seq) => BuildWithConstructor1EnumerableParameter(gt, et, seq),
        [typeof(Queue<>)]               = (gt, et, len, seq) => BuildWithConstructor1EnumerableParameter(gt, et, seq.Cast<object?>()),
        [typeof(SortedSet<>)]           = (gt, et, len, seq) => BuildWithConstructor1EnumerableParameter(gt, et, seq),
